...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=keyboard1.c keyboard2.c main_crypto.c lcd_I2C.c spi.c uart.c uartRFID.c led.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/keyboard1.o ${OBJECTDIR}/keyboard2.o ${OBJECTDIR}/main_crypto.o ${OBJECTDIR}/lcd_I2C.o ${OBJECTDIR}/spi.o ${OBJECTDIR}/uart.o ${OBJECTDIR}/uartRFID.o ${OBJECTDIR}/led.o
POSSIBLE_DEPFILES=${OBJECTDIR}/keyboard1.o.d ${OBJECTDIR}/keyboard2.o.d ${OBJECTDIR}/main_crypto.o.d ${OBJECTDIR}/lcd_I2C.o.d ${OBJECTDIR}/spi.o.d ${OBJECTDIR}/uart.o.d ${OBJECTDIR}/uartRFID.o.d ${OBJECTDIR}/led.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/keyboard1.o ${OBJECTDIR}/keyboard2.o ${OBJECTDIR}/main_crypto.o ${OBJECTDIR}/lcd_I2C.o ${OBJECTDIR}/spi.o ${OBJECTDIR}/uart.o ${OBJECTDIR}/uartRFID.o ${OBJECTDIR}/led.o

# Source Files
SOURCEFILES=keyboard1.c keyboard2.c main_crypto.c lcd_I2C.c spi.c uart.c uartRFID.c led.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/CRYPTO.Xtest.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
